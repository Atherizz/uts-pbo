...
public class Restoran {
    ...
    public void SimulasiKedatanganPelanggan() {
        if (random.nextInt(100) < 10) {
            ...
            System.out.println("\n[SISTEM] Pelanggan baru (" + baru.getNama() + ") datang! Sabar s/d tick "
                    + baru.getBatasAkhirSabar());
        }
    }
    ...
    private int hitungTip(int skorKepuasan, int totalHarga) {
        if (skorKepuasan >= 90)
            return (int) (totalHarga * 0.15);
        if (skorKepuasan >= 70)
            return (int) (totalHarga * 0.10);
        return 0;
    }
    ...
    public int getWaktuSimulasi() {
        return this.waktuSimulasi;
    }
    ...
    public Queue<Pelanggan> getAntrianKasir() {
        return this.antrianKasir;
    }

    public List<Pelanggan> getDaftarMemasak() {
        return this.daftarMemasak;
    }
    ...
    public List<ItemStok> getDaftarStok() {
        return this.daftarStok;
    }

    public Queue<Pelanggan> getAntrianMasak() {
        return this.antrianMasak;
    }

    public void tambahKeuangan(int jumlah) {
        this.keuangan += jumlah;
    }

    public void TampilkanStatus() {
        System.out.println("\n==============================================================");
        System.out.println("| WAKTU: " + this.waktuSimulasi + " tick | KEUANGAN: Rp" + this.keuangan + " | REPUTASI: "
                + this.reputasi + "/100 |");
        System.out.println("================================================================");
